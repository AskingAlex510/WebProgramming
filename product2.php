...
<main>
    ...
    <?php
        ...
        echo'<div class="image-infor">';
            echo'<div class="manage-image">';
                ...
                echo'<img class="main-image" src="./image/store-product/cat4-product4.jpg" alt="Laptop gaming Acer Aspire 7 A715 42G R4ST">';
    ...
    <div class="technical-parameters">
        ...
        <table>
            ...
            <tr>
                <th>RAM</th>
                <td>DDR4 8GB (1 x 8GB) 3200MHz; 2 slots, up to 32GB</td>	
            </tr>
            <tr>
                <th>Hard Drive</th>
                <td>512GB SSD NVMe M.2 PCIe Gen 3 x 2</td>
            </tr>
            <tr>
                <th>Graphics card</th>
    ...
    <div class="recommended-product">
        ...
        <div class="image-tags">
            <div class="set-collum">
                <a href="./product.php"><img src="./image/store-product/cat1-product1.png" alt=""></a>
                <a href="./product.php"><h5>Laptop gaming Acer Aspire 7 A715 42G R4ST</h5></a>
            </div>
            <div class="set-collum">
