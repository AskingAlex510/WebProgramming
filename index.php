...
<main>
    ...
    <div class="scroll_auto">
        <ul class="scroll_content">
            <!--    <label for="s1">New Store 1</label>-->
            <li><a href="./newstore1.html"><img src="./image/logo-store1.jpg" alt="Computer Tech" id="s1"></a></li> 
            <!--    <label for="s1">New Store 1</label>-->
            <li><a href="./newstore1.html"><img src="./image/logo-store2.png" alt="Computer Tech" id="s1"></a></li> 
            <!--    <label for="s1">New Store 1</label>-->
            <li><a href="./newstore1.html"><img src="./image/logo-store3.png" alt="Computer Tech" id="s1"></a></li> 
            <!--    <label for="s1">New Store 1</label>-->
            <li><a href="./newstore1.html"><img src="./image/logo-store4.png" alt="Computer Tech" id="s1"></a></li> 
            <!--    <label for="s1">New Store 1</label>-->
            <li><a href="./newstore1.html"><img src="./image/logo-store5.png" alt="Computer Tech" id="s1"></a></li> 
            <!--    <label for="s1">New Store 1</label>-->
            <li><a href="./newstore1.html"><img src="./image/logo-store1.jpg" alt="Computer Tech" id="s1"></a></li> 
            <!--    <label for="s1">New Store 1</label>-->
            <li><a href="./newstore1.html"><img src="./image/logo-store2.png" alt="Computer Tech" id="s1"></a></li> 
    ...
    <div class="scroll_auto">
        <ul class="scroll_content1">
            <!--    <label for="s1">New Store 1</label>-->
            <li><a href="./newstore1.html"><img src="./image/store-product/cat5-product2.jpg"  alt="product jpg" id="p1"></a></li> 
            <!--    <label for="s2">New Store 2</label>-->
            <li><a href="./newstore1.html"><img src="./image/store-product/cat4-product4.jpg"  alt="product jpg" id="p2"></a></li> 
            <!--    <label for="s1">New Store 1</label>-->
            <li><a href="./newstore1.html"><img src="./image/store-product/cat5-product4.jpg"  alt="product jpg" id="p1"></a></li> 
            <!--    <label for="s2">New Store 2</label>-->
            <li><a href="./newstore1.html"><img src="./image/store-product/cat4-product4.jpg"  alt="product jpg" id="p2"></a></li> 
            <!--    <label for="s1">New Store 1</label>-->
            <li><a href="./newstore1.html"><img src="./image/store-product/cat5-product4.jpg"  alt="product jpg" id="p1"></a></li> 
            ...
            <li><a href="./newstore1.html"><img src="./image/store-product/cat5-product4.jpg"  alt="product jpg" id="p1"></a></li> 
            <!--    <label for="s2">New Store 2</label>-->
            <li><a href="./newstore1.html"><img src="./image/store-product/cat4-product1.jpg"  alt="product jpg" id="p2"></a></li>
            <!--    <label for="s2">New Store 2</label>-->
            <li><a href="./newstore1.html"><img src="./image/store-product/cat4-product2.jpg"  alt="product jpg" id="p2"></a></li>
        </ul>
    </div>
    <section align="center"><header>FEATURED STORES</header></section>
    <div class="display_auto">
        <div class="display_content" >
        <!--    <label for="f1">Featured Store 1</label>-->
            <a href="./newstore1.html"><img src="./image/logo-store1.jpg"  alt="Computer Tech" id="f1"></a>
        <!--    <label for="f2">Featured Store 2</label>-->
            <a href="./newstore1.html"><img src="./image/logo-store4.png"  alt="Computer Tech" id="f2"></a>
        <!--    <label for="f3">Featured Store 3</label>-->
            <a href="./newstore1.html"><img src="./image/logo-store5.png"  alt="Computer Tech" id="f3"></a>
        <!--    <label for="f4">Featured Store 4</label>-->
           <a href="./newstore1.html"><img src="./image/Quality_Store_Logo_g.png"  alt="Computer Tech" id="f4"></a>
        </div>
    </div>
    <section align="center"><header>FEATURED PRODUCTS</header></section>
    <div class="display_auto">
        <div class="display_content" >
            <!--    <label for="s1">New Store 1</label>-->
            <a href="./newstore1.html"><img src="./image/store-product/cat5-product2.jpg" alt="product jpg" id="p1"></a>
            <!--    <label for="s2">New Store 2</label>-->
            <a href="./newstore1.html"><img src="./image/store-product/cat4-product1.jpg"  alt="product jpg" id="p2"></a>
            <!--    <label for="s3">New Store 3</label>-->
            <a href="./newstore1.html"><img src="./image/store-product/cat5-product1.jpg"  alt="product jpg" id="p3"></a>
            <!--    <label for="s4">New Store 4</label>-->
            <a href="./newstore1.html"><img src="./image/store-product/cat3-product2.jpg"  alt="product jpg" id="p4"></a>
        </div>
    </div>
</main>
